        ...
        <Routes>
          ...
          {user?.user?.role === "Sales" && (
            <>
              ...
              <Route
                path='/test_voucher/:pid/:vid'
                element={<TestVoucherPrint />}
              />
          ...
          {user?.user?.role === "Finance" && (
            <>
              ...
              <Route
                path='/account_subhead'
                element={<AccountSubHead />}
              ></Route>
