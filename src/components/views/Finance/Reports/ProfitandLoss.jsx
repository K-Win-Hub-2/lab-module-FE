            ...
            await axios.get(url + `/transactions/trial-balance`, {params:{start:"2023-01-01", end:"2023-12-31"}}).then((res) => {
              ...
              res.data.data.map(element=> {
                if(element.accName === "Autoimmune Diagnosis-Income"){
                  ...
                  aigp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setAutoImmuneGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                }
                ...
                if(element.accName === "Biochemistry-Income"){
                  ...
                  bcgp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setBioChemGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                ...
                if(element.accName === "Haematology-Income"){
                  ...
                  hmgp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setHaemaGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                }
                ...
                if(element.accName === "Histopathology income"){
                  ...
                  hsgp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setHistoGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                }

                if(element.accName === "Immunology-Income"){
                  setImmuRevenue(Math.abs(element.netAmount))
                  setImmuCOGS(Math.abs(element.netAmount) * 0.8)
                  imgp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setImmuGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                }
                ...
                if(element.accName === "Microbiology-Income"){
                  ...
                  migp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setMicroGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                }
                ...
                if(element.accName === "Molecular Diagnosis-Income	"){
                  ...
                  mlgp = Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8)
                  setMoleGP(Math.abs(element.netAmount)-(Math.abs(element.netAmount) * 0.8))
                }
                
                if(element.type.name === "Income" && element.header === "Other Income"){
                  othinc += Math.abs(element.netAmount)
                }

                if(element.type.name === "Expenses" && element.header === "Other Expense"){
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h1 className="card-title font-weight-bold px-3 py-3">
                        Statement of Profit and Loss for the period ended at 31st December 2023
                      </h1>
                      ...
                      <table id="example1" class="table">
                        ...
                        <tbody class="text-center">
                          ...
                          {accountLists.map(account => (
                            (account.type.name === "Income" && account.header === "Other Income") ? 
<tr>
...
<tr>
                          ...
                          {accountLists.map(account => (
                            (account.type.name === "Expenses" && account.header === "Other Expense") ? 
<tr>
